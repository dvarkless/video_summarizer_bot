...
@router.message(F.text.casefold() in replies.possible_answers('change_language'))
...
@router.message(F.text.casefold() in replies.possible_answers('document_format'))
...
@router.message(F.text.casefold() in replies.possible_answers('text_format'))
...
@router.message(F.text.casefold() in replies.possible_answers('document_language'))
